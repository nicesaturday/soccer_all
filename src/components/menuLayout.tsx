        ...
        <nav>
            ...
            <nav>
                <Link href="/game/pl" legacyBehavior>
                    <motion.p  whileHover={{ scale: 1.15 }} className={`cursor-pointer ${whereI.includes("/game") ? "bg-lime-400" : null} hover:bg-lime-400 rounded-md`}>
            ...
            <nav>
                <Link href="/chat" legacyBehavior>
                 <motion.p  whileHover={{ scale: 1.15 }} className={`cursor-pointer ${whereI.includes("/chat") ? "bg-lime-400" : null} hover:bg-lime-400 rounded-md`}>
